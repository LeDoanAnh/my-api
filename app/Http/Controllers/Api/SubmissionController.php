...
class SubmissionController extends Controller
{
    ...
    public function getStatistics(Request $request): JsonResponse
    {
        ...
        $stats = [
            ...
            'pending_submissions' => Submission::where('user_id', $userId)->where('status', 'pending')->count(),
            'rejected_submissions' => Submission::where('user_id', $userId)->where('status', 'rejected')->count(),
        ];
